...
reactions, print a bench-ready pipetting sheet, and analyze the resulting
...
SDK-style webhook handlers, and entity mapping that converts the design/results
into Benchling Request/Result/Entry payload shapes.
